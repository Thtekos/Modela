...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Register function will handle redirect
    } catch (err) {
      ...
      <div className="min-h-screen bg-charcoal flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-400">
            Or{" "}
            <Link href="/auth/login" className="font-medium text-electric-blue hover:text-blue-400">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="terms" className="ml-2 block text-sm text-gray-300">
                  I agree to the{" "}
                  <a href="#" className="text-electric-blue hover:text-blue-400">
                    Terms of Service
                  </a>{" "}
                  and{" "}
                  <a href="#" className="text-electric-blue hover:text-blue-400">
